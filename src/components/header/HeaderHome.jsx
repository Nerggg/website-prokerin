...
function Header() {
  ...
  return (
    <div className="bg-white w-full h-[130px] flex items-center">
      ...
      <div
        className="z-50 w-[110px] h-[40px] border border-black rounded-full mr-[2%] flex justify-center items-center cursor-pointer"
        onClick={handleInClick}
      >
        Sign in
      </div>
      <div
        className="z-50 w-[110px] h-[40px] bg-red-400 rounded-full flex justify-center items-center text-white cursor-pointer"
