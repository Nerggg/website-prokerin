...
function Home() {
  return (
    <div>
      ...
      <div className="w-[120px] h-[8px] mt-[26px] bg-red-500 rounded-full ml-[6%]" />
      ...
      <div className="w-[110px] h-[40px] bg-red-500 rounded-full flex justify-center items-center text-white ml-[6%] mt-[26px]">Learn More</div>
    </div>
  );
}
