  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="ml-[14%] flex items-center py-[10px]">
        <Icon path={mdiAccountCircleOutline} className="w-auto h-[60px] ml-[1%]" />
              ...
              return (
                <div className='rounded-[10px] border-2 border-gray-100 w-[300px] h-[100px] shadow-lg flex justify-between px-2 cursor-pointer' >
                  <div className='flex items-center ml-2'>
                    <img src={item.image} className='h-[50px] w-[50px] rounded-full' />
                    <div className='ml-2'>
                      <p className='font-semibold'>{item.name}</p>
                      <p className='text-[12px] text-gray-500'>{item.position}</p>
                    </div>
                  </div>
